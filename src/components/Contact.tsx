  ...
  return (
    <section id="contact" className="py-32 px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <p className="text-xs text-[#c4611a] tracking-[0.2em] uppercase mb-4">
            Contact
          </p>
          <h2 className="text-4xl sm:text-5xl font-bold text-[#1e1008] mb-6">
            Let&apos;s talk.
          </h2>
          <p className="text-[#967040] leading-relaxed mb-12 max-w-lg mx-auto">
          ...
          <a
            ...
            className="inline-block px-8 py-4 bg-[#c4611a] text-white text-sm font-semibold rounded-lg hover:bg-[#b05218] transition-colors duration-200 mb-16"
          >
            Say Hello
          </a>
      ...
      >
        <p className="font-mono text-xs text-[#7a4c26]">
